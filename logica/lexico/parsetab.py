...
_lr_productions = [
  ...
  ('declaracion_variable -> VAR ID ASIGNAR expresion PUNTOCOMA','declaracion_variable',5,'p_declaracion_variable','sintactico.py',158),
  ('declaracion_variable -> VAR ID PUNTOCOMA','declaracion_variable',3,'p_declaracion_variable','sintactico.py',159),
